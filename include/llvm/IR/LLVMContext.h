...
public:
  ...
  void emitError(const Twine &ErrorStr, DiagnosticSeverity Severity);
  ...
  /// getNamedStructTypes - Returns map of structure type declaration.
  StringMap<StructType *> & getNamedStructTypes();
