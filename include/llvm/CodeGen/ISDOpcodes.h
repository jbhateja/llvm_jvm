...
namespace ISD {
  ...
  enum NodeType {
    ...
    /// New macro DAG nodes to capture Array and Structure references.
    /// This preserves the indices by avoiding any index to offset conversions.
    ARRAY_REF, STRUCT_REF,
