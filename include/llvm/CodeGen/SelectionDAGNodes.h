...
private:
  ...
  // Following flag is used while DAG linearization, this has
  // similar semantics to Glue property.
  // A node having this flag will cause its operands to be
...
public:
  ...
  void setGlueOperands(bool b) {
    setDefined();
    GlueOperands = b;
  }

  void setIsComposite(bool b) {
    setDefined();
    isComposite = b;
  }
 
  void setIsStructAcc(bool b) {
    setDefined();
    isStructAcc = b;
  }

  void setIsArrayAcc(bool b) {
    setDefined();
    isArrayAcc = b;
  }

  void setIsUseAbsorb(bool b) {
    setDefined();
    isUseAbsorb = b;
  }

  void setIsAbsorptionCandidate(bool b) {
    setDefined();
    isAbsorptionCandidate = b;
  }
  ...
  bool hasGlueOperands() const { return GlueOperands; }
  bool hasIsComposite() const { return isComposite; }
  bool hasIsStructAcc() const { return isStructAcc; }
  bool hasIsArrayAcc() const { return isArrayAcc; }
  bool hasIsUseAbsorb() const { return isUseAbsorb; }
  bool hasIsAbsorptionCandidate() const { return isAbsorptionCandidate; }
