...
void createMemCpyLoopKnownSizeUnwrapped(Instruction *InsertBefore,
                                        Value *SrcAddr, Value *DstAddr,
                                        ConstantInt *CopyLen, unsigned SrcAlign,
                                        unsigned DestAlign, bool SrcIsVolatile,
                                        bool DstIsVolatile, Type *LoopOpType,
                                        unsigned TripCount,
                                        const TargetTransformInfo &TTI);
...
void expandMemSetAsLoopUnwrapped(Instruction *InsertBefore, Value *DstAddr,
