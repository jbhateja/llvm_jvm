...
public:
  ...
  /// Instruction to be consumed before entering MC world.
  bool isConsumeBeforeMC() const { return Flags & (1ULL << MCID::ConsumeBeforeMC); }

  /// Instruction is a register class converter.
  bool isRegCConv() const { return Flags & (1ULL << MCID::isRegCConv); }
