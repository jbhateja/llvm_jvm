...
void llvm::createMemCpyLoopKnownSizeUnwrapped(Instruction *InsertBefore, Value *SrcAddr,
                                              Value *DstAddr, ConstantInt *CopyLen,
                                              unsigned SrcAlign, unsigned DestAlign,
                                              bool SrcIsVolatile, bool DstIsVolatile,
                                              Type * LoopOpType, unsigned TripCount,
  ...
  uint64_t LoopEndCount = TripCount;
  ...
  uint64_t BytesTotal = CopyLen->getZExtValue();
  uint64_t RemainingBytes = BytesTotal - BytesCopied;
  if (RemainingBytes) {
...
void llvm::createMemCpyLoopKnownSize(Instruction *InsertBefore, Value *SrcAddr,
  ...
  createMemCpyLoopKnownSizeUnwrapped(InsertBefore, SrcAddr, DstAddr, CopyLen,
                                 SrcAlign, DestAlign, SrcIsVolatile, DstIsVolatile,
                                 LoopOpType, LoopEndCount, TTI);
}
...
void llvm::expandMemSetAsLoopUnwrapped(Instruction *InsertBefore, Value *DstAddr,
                              ConstantInt *CopyLen, Value *SetValue, unsigned Alignment,
                              bool IsVolatile) {
  createMemSetLoop(InsertBefore, DstAddr, CopyLen, SetValue, Alignment, IsVolatile);
}
