...
bool LLVMTargetMachine::addAsmPrinter(PassManagerBase &PM,
  ...
  case CGFT_AssemblyFile: {
    ...
    raw_ostream *SOut = &Out;
    if (MAI.getEnableAsmInMemoryEmitting()) {
       SOut = new raw_string_ostream(MAI.getAsmMemoryBuffer());   
    }

    auto FOut = llvm::make_unique<formatted_raw_ostream>(*SOut);
