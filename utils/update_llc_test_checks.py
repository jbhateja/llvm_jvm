  ...
  for test in args.tests:
    ...
    for input_line in input_lines:
      if is_in_function_start:
        ...
        triple = triple_in_cmd or triple_in_ir or 'x86'
        emit_label = asm.check_emitting_label_at_func_start(triple)
        # Print out the various check lines here.
        asm.add_asm_checks(output_lines, ';', run_list, func_dict, func_name, emit_label)
        is_in_function_start = False
